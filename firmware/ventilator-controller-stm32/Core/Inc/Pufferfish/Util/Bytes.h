 ...
 * @tparam byte_index the shift index of the byte, where 0 leaves it unshifted (in the least significant byte position)
 ...
 * @param byte the byte to shift
 * @param byte_index the shift index of the byte, where 0 leaves it unshifted (in the least significant byte position)
 * @tparam T the type of the number to return
 * @return A number of the specified type with the given byte shifted into the given location
 */
template <typename T>

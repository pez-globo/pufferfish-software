...
typedef enum _LogEventCode {
    ...
    LogEventCode_backend_connection_down = 10,
    LogEventCode_backend_connection_up = 11,
    /* Control */
    LogEventCode_ventilation_operation_changed = 12,
    LogEventCode_ventilation_mode_changed = 13,
    LogEventCode_fio2_setting_changed = 14,
    LogEventCode_flow_setting_changed = 15,
    /* Alarm Limits */
    LogEventCode_fio2_alarm_limits_changed = 16,
    LogEventCode_flow_alarm_limits_changed = 17,
    LogEventCode_spo2_alarm_limits_changed = 18,
    LogEventCode_hr_alarm_limits_changed = 19
} LogEventCode;

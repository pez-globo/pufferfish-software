...
typedef struct _ScreenStatusRequest { 
    bool lock; 
} ScreenStatusRequest;
...
#define ScreenStatusRequest_init_default         {0}
...
#define ScreenStatusRequest_init_zero            {0}
...
#define ScreenStatusRequest_lock_tag             1
...
#define ScreenStatusRequest_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, BOOL,     lock,              1)
#define ScreenStatusRequest_CALLBACK NULL
#define ScreenStatusRequest_DEFAULT NULL
...
extern const pb_msgdesc_t ScreenStatusRequest_msg;
...
#define ScreenStatusRequest_fields &ScreenStatusRequest_msg
...
#define ScreenStatusRequest_size                 2
...
template <>
struct MessageDescriptor<ScreenStatusRequest> {
    static PB_INLINE_CONSTEXPR const pb_size_t fields_array_length = 1;
    static PB_INLINE_CONSTEXPR const pb_msgdesc_t* fields() {
        return &ScreenStatusRequest_msg;
    }
};
template <>

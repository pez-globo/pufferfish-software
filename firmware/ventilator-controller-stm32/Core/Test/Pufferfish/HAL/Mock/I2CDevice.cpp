...
SCENARIO("I2C mock device works correctly for add_read and read method") {
  GIVEN("Freshly constructed mock device") {
    ...
    WHEN(
        ...
        "I2CDeviceStatus and count is initialized to 50 and then read method is called with input "
        "parameter count initialized to 50, ") {
    ...
    WHEN(
        ...
        "read_error I2CDeviceStatus, and count is initialized to 50 and then read method is called "
        "with input parameter count initialized to 50") {
    ...
    WHEN(
        "The add_read method is called with input parameters [a0 e8 d4 fd 97]bytes, and "
        "crc_check_failed I2CDeviceStatus and count is initialized to 50 and then read method is "
        "called with input parameter count initialized to 50") {
    ...
    WHEN(
        "The add_read method is called with input parameters [a0 e8 d4 fd 97]bytes, and "
        "test_failed I2CDeviceStatus, and count is initialized to 50 and then read method is "
        "called with input parameter count initialized to 50") {
...
SCENARIO(
  ...
  GIVEN("Freshly constructed mock device") {
    ...
    WHEN(
        ...
        "I2CDeviceStatus and count is initialized to 50, then read method is called six times with "
        "input parameter count initialized to 50") {
      PF::Util::Containers::ByteVector<buffer_size> input_read;
    ...
    WHEN(
        ...
        "I2CDeviceStatus and count is initialized to 50, then read method is called four times "
        "with input parameter count set to 50") {
      PF::Util::Containers::ByteVector<buffer_size> input_read;
      PF::Util::Containers::ByteVector<buffer_size> input_read1;
      PF::Util::Containers::ByteVector<buffer_size> input_read2;
      PF::Util::Containers::ByteVector<buffer_size> input_read3;
    ...
    WHEN(
        ...
        "bytes and [ok][ok][ok] I2CDeviceStatus and count is initialized to 50, then read method "
        "is called three times with input parameter count initialized to 50") {
      PF::Util::Containers::ByteVector<buffer_size> input_read;
      PF::Util::Containers::ByteVector<buffer_size> input_read1;
      PF::Util::Containers::ByteVector<buffer_size> input_read2;
      PF::Util::Containers::ByteVector<buffer_size> input_read3;
...
SCENARIO(
    "Mock I2CDevice works correctly when add_read method and read method is called alternately") {
  GIVEN("Freshly constructed mock device") {
    PF::HAL::Mock::I2CDevice mock_device;
    constexpr size_t buffer_size = 50UL;
    size_t count = buffer_size;
    WHEN(
        "The add_read method  with input parametes,[27 b8] and I2CDeviceStatus [ok] and count is "
        "initialized to 50 ,is called and "
        "then read method is called , add_read and read method is called alternatively for 6 more "
        "times with input "
        "parameter [64 f3] [2f 1c] "
        "[39 25] [f3 9e] [a9 78] [9c 7f] and [ok][ok][ok][ok][ok][ok]"
        "I2CDeviceStatus ") {
      PF::Util::Containers::ByteVector<buffer_size> input_read;
      PF::Util::Containers::ByteVector<buffer_size> input_read1;
      PF::Util::Containers::ByteVector<buffer_size> input_read2;
      ...
      auto read_buffer2 = PF::Util::Containers::make_array<uint8_t>(0x2f, 0x1c);
      ...
      auto read_buffer3 = PF::Util::Containers::make_array<uint8_t>(0x39, 0x25);
      ...
      auto read_buffer6 = PF::Util::Containers::make_array<uint8_t>(0x9c, 0x7f);
...
SCENARIO(
  ...
  GIVEN("Freshly constructed mock device") {
    ...
    size_t count = buffer_size;
    WHEN(
        "The add_read method is called two times , for first call input parameters were 50 bytes "
        "[63 ...... ce 3f] and OK I2CDeviceStatus and count is initialized to 50, for second "
        "method call, 25 data "
        "bytes [eb ... 09 31] and ok "
        "I2CDeviceStatus and count is initialized to 50 ,then read method is called twice with "
        "input parameter count initilized to 50") {
      auto status = PF::I2CDeviceStatus::ok;
...
SCENARIO("Mock I2CDevice works correctly for write method and get_write method") {
  GIVEN("A freshly constructed mock device") {
    ...
    size_t count = 5;
    WHEN(
        "The write method is called with input parameter [d5 1a 7a bc 24]bytes, add_write_status "
        "method is called with input Ok "
      ...
      THEN("The get_write method's output parameter count has value 50") { REQUIRE(count == 50); }
    ...
    WHEN(
        ...
        "add_write_status with input parameter  "
      ...
      THEN("The output parameter of get_write method count has value 50") { REQUIRE(count == 50); }
      THEN("The get_write method call returns ok status") {
        REQUIRE(status_write == PF::I2CDeviceStatus::ok);
      }
      THEN("After the get_write method call, output buffer contains [d5 1a 7a bc 24] bytes") {
    ...
    WHEN(
        ...
        "add_write_status method is called with parameter"
      ...
      THEN("The get_write method output parameter count has value 50") { REQUIRE(count == 50); }
      THEN("The get_write method call returns ok status") {
        REQUIRE(status_write == PF::I2CDeviceStatus::ok);
      }
      THEN("After the get_write method call, output buffer contains [d5 1a 7a bc 24] bytes") {
...
SCENARIO(
  ...
  GIVEN("Freshly constructed mock-device") {
    ...
    WHEN(
        ...
        "[22 19]and add_write_staus is called five times with input I2CDevice status as [Ok] "
    ...
    WHEN(
        ...
        "and add_write_status is called four times with input I2CDevice status as [Ok] "
    ...
    WHEN(
        ...
        "and add_write_status is called with input [Ok] [ok] [ok] I2CDevice status, then get_write "
...
SCENARIO(
    "Mock device works correctly when write method is  get_write method is called "
  ...
  GIVEN("Freshly constructed mock-device") {
    ...
    WHEN(
        "The write method is called with input paramter [db fe] and add_write_status method is "
...
SCENARIO(
  ...
  GIVEN("Freshly constructed mock device") {
    ...
    WHEN(
        ...
        "[63 ... 09 31] and add_write_status is called with input parameter [ok][ok] "
        "I2CDeviceStatus and second method call has input parameter [eb .. 09 31] and "
        "add_write_status is called with input OK I2CDeviceStatus") {
      auto status = PF::I2CDeviceStatus::ok;
      ...
      THEN(
          "After the second get_write method call, get_write buffer contains expected 25 data "
          "bytes [eb ... 09 31]") {
        auto read_buffer1 =

...
SCENARIO("I2C mock device works correctly for add_read and read method") {
  GIVEN("Freshly constructed mock device") {
    ...
    WHEN(
        ...
        "I2CDeviceStatus and then read method is called") {
    ...
    WHEN(
        ...
        "read_error I2CDeviceStatus and then read method is called") {
    ...
    WHEN(
        "The add_read method is called with input parameters [a0 e8 d4 fd 97]bytes, and "
        "crc_check_failed I2CDeviceStatus and then read method is called") {
    ...
    WHEN(
        "The add_read method is called with input parameters [a0 e8 d4 fd 97]bytes, and "
        "test_failed I2CDeviceStatus, and then read method is called") {
...
SCENARIO(
  ...
  GIVEN("Freshly constructed mock device") {
    ...
    WHEN(
        ...
        "I2CDeviceStatus and then read method is called six times") {
      PF::Util::Containers::ByteVector<buffer_size> input_read;
    ...
    WHEN(
        ...
        "I2CDeviceStatus and then read method is called four times") {
      PF::Util::Containers::ByteVector<buffer_size> input_read;
      PF::Util::Containers::ByteVector<buffer_size> input_read1;
      PF::Util::Containers::ByteVector<buffer_size> input_read2;
      PF::Util::Containers::ByteVector<buffer_size> input_read3;
    ...
    WHEN(
        ...
        "bytes and [ok][ok][ok] I2CDeviceStatus and then read method is called three times") {
      PF::Util::Containers::ByteVector<buffer_size> input_read;
      PF::Util::Containers::ByteVector<buffer_size> input_read1;
      PF::Util::Containers::ByteVector<buffer_size> input_read2;
      PF::Util::Containers::ByteVector<buffer_size> input_read3;
...
SCENARIO(
    "Mock I2CDevice works correctly when add_read method and read method is called one after "
    "other") {
  GIVEN("Freshly constructed mock device") {
    PF::HAL::Mock::I2CDevice mock_device;
    constexpr size_t buffer_size = 50UL;
    size_t count = buffer_size;
    WHEN(
        "The add_read method  with input parametes,[27 b8] and I2CDeviceStatus [ok] is called and "
        "then read method is called , this pattern is repeated for 6 more times with input "
...
SCENARIO(
    "I2C mock device works correctly for  add_read method when input parameter has 50 bytes and 20 "
    "bytes "
    "then read method is called") {
  GIVEN("Freshly constructed mock device") {
    PF::HAL::Mock::I2CDevice mock_device;
    constexpr size_t buffer_size = 50UL;
    size_t count = buffer_size;
    WHEN(
        "The add_read method is called with input parameters, 50 bytes [63 89 9a a9 27 54 0e 5e 90 "
        "c2 15 21 45 e1 e1 bb 99 55 73 a6 a4 04 27 ae 2d 1a f0 43 d6 76 d8 b6 ce 30 fc 89 e6 f2 e9 "
        "eb e0 73 a3 09 9a 4c 13 e3 ce 3f], followed by 25 data "
        "bytes [eb 65 a1 62 93 13 33 23 ff 97 ba 63 f2 46 46 dd 1a 64 a2 c1 50 04 d3 09 31] and ok "
        "I2CDeviceStatus then read method is called twice") {
      auto status = PF::I2CDeviceStatus::ok;
      ...
      THEN(
          "After the first read method, read buffer contains expected 50 data bytes [63 89 9a a9 "
          "27 54 0e 5e 90 c2 15 21 45 e1 "
      ...
      THEN(
          "After the second read method call,  read buffer contains expected 25 data bytes [eb 65 "
          "a1 62 93 13 33 23 ff 97 ba 63 f2 "
...
SCENARIO(
    ...
    "50 bytes followed by 25 byted ,and [OK] [OK] I2C DeviceStatus") {
  GIVEN("Freshly constructed mock device") {
    PF::HAL::Mock::I2CDevice mock_device;
    constexpr size_t buffer_size = 50UL;
    size_t count = 0;
    WHEN(
        "The write method is called with input parameters, 50 data bytes [63 89 9a a9 27 54 0e 5e "
        "90 c2 "
        "15 21 45 e1 e1 bb 99 55 73 a6 a4 04 27 ae 2d 1a f0 43 d6 76 d8 b6 ce 30 fc 89 e6 f2 e9 eb "
        "e0 73 a3 09 9a 4c 13 e3 ce 3f] followed by 25 data bytes [eb 65 a1 62 93 13 "
        "33 23 ff 97 ba 63 f2 46 46 dd 1a 64 a2 c1 50 04 d3 09 31] and [ok][ok] I2CDeviceStatus") {
      auto status = PF::I2CDeviceStatus::ok;
      ...
      THEN("The count returns value 50") { REQUIRE(count == 50); }
      THEN("The first get_write method returns OK status") {
        REQUIRE(write_status == PF::I2CDeviceStatus::ok);
      }
      THEN(
          "After the first get_write method call, get_write buffer contains expected 50 data bytes "
          "[63 89 9a a9 27 54 0e 5e 90 c2 "
          "15 21 45 "
      ...
      THEN(
          ...
          "bytes [eb 65 a1 62 93 13 33 23 ff 97 ba "

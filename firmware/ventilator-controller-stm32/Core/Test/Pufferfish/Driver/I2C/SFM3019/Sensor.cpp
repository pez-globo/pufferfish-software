...
SCENARIO("The Sensor::setup method works correctly for different mock read buffer ") {
  ...
  GIVEN(
      ...
      "is "
      "set to [01] byte and read buffer is set to [01 02]") {
    PF::HAL::Mock::I2CDevice mock_device;
    PF::HAL::Mock::I2CDevice global_device;
    PF::Driver::I2C::SFM3019::GasType gas = PF::Driver::I2C::SFM3019::GasType::o2;
    PF::Driver::I2C::SFM3019::Device device{mock_device, global_device, gas};
...
SCENARIO(
  ...
  GIVEN(
      ...
      "of[00 aa a6 a0 00 "
      "7e 00 00 81](as invalid read_product_id response) [04 02 60 06 11 a9 00 00 81] (as valid "
      "read_product_id "
      "response) "
      "and[00 aa a6 a0 00 7e 00 00 81](as valid read_conversion_factor response) [15 35 "
      "a8](as valid read_sample response) followed by junk bytes [01 02], reseter is set to "
      "false and mock time set to 100us, global device's mock write buffer is set to [01] byte and "
...
SCENARIO(
  ...
  GIVEN(
      "SFMC3019 sensor is created with mock I2C device with read buffer consists of[04 02 60 06 11 "
      "a9 00 00 81] (as a valid read_product_id response) "
      "and 7 repetition of [04 02 60 06 11 a9 00 00 81] bytes(invalid read_conversion_factor "
...
SCENARIO("The Sensor::output method works correctly when read buffer is not as expected") {
  GIVEN(
      ...
      "action returns wait_measurement with the mock read buffer consisting of 8 repition of[0f 80 "

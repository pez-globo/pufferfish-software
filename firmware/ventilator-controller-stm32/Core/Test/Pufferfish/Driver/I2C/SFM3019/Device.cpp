...
//         "ConversionFactors "
//         "output parameter and with the read buffer of mock I2C device consisting 0x[ae dc 6a 00
//         00 " "81 00 00 81]") {
//       PF::Driver::I2C::SFM3019::Device device{mock_device, global_device, gas};
...
//         "ConversionFactors "
//         "output parameter and with the read buffer of mock I2C device consisting 0x[ae dc 6a 00
//         00 " "81 00 00 81], corresponding to scale factor 10 and offset of -5") {
//       PF::Driver::I2C::SFM3019::Device device{mock_device, global_device, gas};
//       PF::Driver::I2C::SFM3019::ConversionFactors conversion;
...
//         "ConversionFactors "
//         "output parameter and with the read buffer of mock I2C device consisting 0x[ae dc 6a 00
//         00 " "81 00 00 81], corresponding to scale factor 170 and offset of -24576") {
//       PF::Driver::I2C::SFM3019::Device device{mock_device, global_device, gas};
//       PF::Driver::I2C::SFM3019::ConversionFactors conversion;
...
//         parameter where mock I2C's read buffer is set to " "0x[ae, dc, 6a]") {
//       PF::Driver::I2C::SFM3019::Device device{mock_device, global_device, gas};
...
//         "The read_sample function is called with  scale factor of 170 and an offset of  -24576 as
//         " "input parameters, and a Sample object " "initialized to default as the output
//         parameter where mock I2C's read buffer is set to " "0x[15, 35, a8]") {
//       PF::Driver::I2C::SFM3019::Device device{mock_device, global_device, gas};
//       conversion.scale_factor = 170;
//       conversion.offset = -24576;
//       auto status = device.read_sample(conversion, sample);
...
//         "The read_sample function is called with  scale factor of 170 and an offset of  -24576 as
//         " "input parameters, and a Sample object " "initialized to default as the output
//         parameter where mock I2C's read buffer is set to " "0x[74, 6f, ac]") {
//       PF::Driver::I2C::SFM3019::Device device{mock_device, global_device, gas};
//       conversion.scale_factor = 170;
//       conversion.offset = -24576;
//       auto status = device.read_sample(conversion, sample);

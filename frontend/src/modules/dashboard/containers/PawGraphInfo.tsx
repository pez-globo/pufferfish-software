...
import { getWaveformPawOld, getWaveformPawNew } from '../../../store/controller/selectors';
...
const PawWaveform = ({ data, width, height, strokeWidth, fill }: WaveformProps): JSX.Element => (
  <Waveform
    type="paw"
    fill={fill}
    width={width}

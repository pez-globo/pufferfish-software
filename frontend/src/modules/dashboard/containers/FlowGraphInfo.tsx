...
import { getWaveformFlowOld, getWaveformFlowNew } from '../../../store/controller/selectors';
...
const FlowWaveform = ({ data, width, height, strokeWidth, fill }: WaveformProps): JSX.Element => (
  <Waveform
    type="flow"
    fill={fill}
    width={width}

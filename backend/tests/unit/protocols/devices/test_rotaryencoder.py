...
re_examples = [
    (pb.RotaryEncoder(
        step=0, last_step_change=1600876180.591,
    ...
    (pb.RotaryEncoder(
        step=2, last_step_change=1600876184.850,
        button_pressed=False, last_button_down=1600876184.141,
        last_button_up=1600876184.242
    ), 1600876184.850, False, 2),
    (pb.RotaryEncoder(
        step=3, last_step_change=1600876185.458,
        button_pressed=False, last_button_down=1600876184.141,
        last_button_up=1600876184.242
    ), 1600876185.458, False, 3),
    (pb.RotaryEncoder(
        step=8, last_step_change=1600876185.559,
        button_pressed=False, last_button_down=1600876184.141,
        last_button_up=1600876184.242
    ), 1600876185.559, False, 8),
    (pb.RotaryEncoder(
        step=14, last_step_change=1600876186.268,
        button_pressed=False, last_button_down=1600876184.141,
        last_button_up=1600876184.242
    ...
    (pb.RotaryEncoder(
        step=0, last_step_change=1600876186.979,
...
def test_re_button_dial_time_change(
    ...
    receiver = rotary_encoder.Receiver()
    last_step = 0
